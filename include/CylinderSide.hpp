...
namespace loco
{
  ...
  protected:
    ...
    void generateBuffer(const std::vector<float> &positions, const std::vector<float> &radius,
  ...
  public:
    CylinderSide(const std::vector<float> &positions, const std::vector<float> &radius,
