...
//    visualizer.addMesh(std::vector<float>(mesh + 9, mesh + 18), loco::color::WHITE);
    ...
    visualizer.addPointCloud(std::vector<float>(mesh, mesh + 18), loco::color::WHITE, 0.2f);
//    visualizer.addPointCloud(std::vector<float>(mesh, mesh + 18), std::vector<float>(color, color + 24), 0.2f);
